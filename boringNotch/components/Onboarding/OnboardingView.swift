        ...
        ZStack {
            ...
            case .cameraPermission:
                PermissionRequestView(
                    ...
                    description: "Notch Master includes a mirror feature that lets you quickly check your appearance using your camera, right from the notch. Camera access is required only to show this live preview. You can turn the mirror feature on or off at any time in the app.",
            ...
            case .calendarPermission:
                PermissionRequestView(
                    ...
                    description: "Notch Master can show all your upcoming events in one place. Access to your calendar is needed to display your schedule.",
                ...
                case .remindersPermission:
                    PermissionRequestView(
                        ...
                        description: "Notch Master can show your scheduled reminders alongside your calendar events. Access to Reminders is needed to display your reminders.",
            ...
            case .audioCapturePermission:
                PermissionRequestView(
                    ...
                    description: "Notch Master can analyze the audio playing from your music app to draw a live FFT waveform in the notch, with only a minimal impact on CPU usage.",
